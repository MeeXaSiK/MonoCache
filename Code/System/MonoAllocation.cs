...
namespace NTC.Global.System
{
    public abstract class MonoAllocation : MonoBehaviour
    {
        ...
        public void EnableAllocation() => allocationEnabled = true;

        public void DisableAllocation() => allocationEnabled = false;
        ...
        public T GetCached<T>() where T : Component => GetSingleCached(_get, GetComponent<T>);

        public T[] GetsCached<T>() where T : Component => GetManyCached(_gets, GetComponents<T>);

        public T ChildrenGetCached<T>() where T : Component => GetSingleCached(_childrenGet, GetComponentInChildren<T>);

        public T[] ChildrenGetsCached<T>() where T : Component => GetManyCached(_childrenGets, GetComponentsInChildren<T>);

        public T ParentGetCached<T>() where T : Component => GetSingleCached(_parentGet, GetComponentInParent<T>);

        public T[] ParentGetsCached<T>() where T : Component => GetManyCached(_parentGets, GetComponentsInParent<T>);

        public T FindCached<T>() where T : Component => GetSingleCached(_find, FindObjectOfType<T>);

        public T[] FindsCached<T>() where T : Component => GetManyCached(_finds, FindObjectsOfType<T>);
